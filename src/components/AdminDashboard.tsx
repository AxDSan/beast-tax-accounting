  ...
  return (
    <>
      ...
      <motion.button
        ...
        whileTap={{ scale: 0.9 }}
        onClick={() => {
          setFormData(config); // Sync form with latest config when opening
          setIsOpen(true);
        }}
            ...
            >
              <div className="p-8 overflow-y-auto">
                <div className="flex justify-between items-center mb-8">
                  <h2 className="text-2xl font-bold text-dark dark:text-white">{t.admin?.title || "Admin Dashboard"}</h2>
                  <button
                    onClick={() => setIsOpen(false)}
