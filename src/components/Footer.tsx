        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li><a href="#services" className="text-gray-400 hover:text-red-400 transition-colors text-sm font-sans">
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li><a href="#specialized-services" className="text-gray-400 hover:text-red-400 transition-colors text-sm font-sans">
        ...
        <div className="border-t border-red-900/20 pt-12">
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            ...
            <div className="flex gap-8 text-sm font-sans">
              ...
              <Link to="/terms-and-conditions" className="text-gray-500 hover:text-red-400 transition-colors">
